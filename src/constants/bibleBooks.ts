...
export const bibleBooks: Book[] = [
    ...
    { name: 'Song of Solomon', abbreviation: 'SOS', chapters: 8 },
    ...
    { name: 'John', abbreviation: 'JON', chapters: 21 },
    ...
    { name: 'Tobit', abbreviation: 'TOB', chapters: 14 },
    { name: 'Judith', abbreviation: 'JUD', chapters: 7 },
    { name: 'Wisdom of Solomon', abbreviation: 'WIS', chapters: 14 },
    { name: 'Sirach', abbreviation: 'SIR', chapters: 51 },
    { name: 'Baruch', abbreviation: 'BAR', chapters: 5 },
    { name: 'Letter of Jeremiah', abbreviation: 'LJE', chapters: 1 },
