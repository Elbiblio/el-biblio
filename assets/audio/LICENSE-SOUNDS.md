...
All audio assets in this directory are licensed under **Creative Commons CC0 1.0 Universal**
...
|------|-----------|--------|---------|
| `ding.wav` | TODO: fill in Pixabay/Freesound URL | TODO | CC0 |
| `correct.mp3` | TODO | TODO | CC0 |
| `wrong.mp3` | TODO | TODO | CC0 |
| `success_bell.mp3` | TODO | TODO | CC0 |
| `level-up.mp3` | TODO | TODO | CC0 |
| `ui-tap.mp3` | stub copy of ding.wav | — | CC0 |
| `ui-success.mp3` | stub copy of correct.mp3 | — | CC0 |
| `ui-complete.mp3` | stub copy of level-up.mp3 | — | CC0 |
| `ui-error.mp3` | stub copy of wrong.mp3 | — | CC0 |
| `transition-whoosh.mp3` | stub | — | CC0 |
| `page-turn.mp3` | stub copy of ding.wav | — | CC0 |
| `paper-rustle.mp3` | stub copy of ding.wav | — | CC0 |
| `welcome-shiny.mp3` | stub copy of success_bell.mp3 | — | CC0 |
...
| File | Source URL | Author | License |
|------|-----------|--------|---------|
| `countdown/*.mp3` | TODO | TODO | CC0 |
| `prompts/*.mp3` | TODO | TODO | CC0 |

---

> **Note:** Replace all `TODO` entries with actual source URLs, author names, and license versions
> before publishing the app to production. CC0 requires no attribution but it is best practice
> to keep records here for auditing purposes.
