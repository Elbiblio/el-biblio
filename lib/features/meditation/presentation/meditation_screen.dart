...
class _MeditationScreenState extends ConsumerState<MeditationScreen>
  ...
  Future<bool> _onWillPop() async {
    ...
    if (phase == MeditationPhase.active ||
      ...
      if (shouldEnd == true) {
        await ref.read(meditationProvider.notifier).endSession();
        return true;
      }
      return false;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          body: SafeScrollableContent(
            bottomPadding: state.phase == MeditationPhase.setup ? 16 : 120,
            child: SafeArea(
              child: Column(
                children: [
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: switch (state.phase) {
                        ...
                        MeditationPhase.active =>
                          state.guidedContent != null
                              ? const ImmersiveGuidedMeditationView(key: ValueKey('immersive'))
