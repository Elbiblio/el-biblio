...
// Welcome illustration - Gentle compass with soft light
...
<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Background circle -->
  <circle cx="100" cy="100" r="80" fill="url(#welcomeGradient)" />
  
  <!-- Compass circle -->
  <circle cx="100" cy="100" r="60" fill="none" stroke="url(#compassGradient)" stroke-width="2" opacity="0.6" />
  
  <!-- Compass star -->
  <path d="M100,40 L110,90 L160,100 L110,110 L100,160 L90,110 L40,100 L90,90 Z" 
        fill="url(#compassGradient)" opacity="0.7" />
  
  <!-- Center point -->
  <circle cx="100" cy="100" r="8" fill="#1E40AF" opacity="0.8" />
  
  <!-- Gentle rays -->
  <g opacity="0.3">
    <line x1="100" y1="20" x2="100" y2="35" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" />
    <line x1="180" y1="100" x2="165" y2="100" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" />
    <line x1="100" y1="180" x2="100" y2="165" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" />
    <line x1="20" y1="100" x2="35" y2="100" stroke="#3B82F6" stroke-width="2" stroke-linecap="round" />
  </g>
</svg>
''';
