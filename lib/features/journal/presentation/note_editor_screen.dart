...
class _NoteEditorScreenState extends ConsumerState<NoteEditorScreen> {
  ...
  bool _isNoteEmpty() {
    return _titleController.text.trim().isEmpty && _quillController.document.isEmpty();
  }
    ...
    try {
      ...
      if (widget.noteId != null) {
        ...
        await XPService.instance.addXP(
          ...
          description: 'Created journal entry: ${_titleController.text.isNotEmpty ? _titleController.text : "Untitled"}',
          metadata: {
            'title': _titleController.text,
            'virtues': _selectedVirtues,
        ...
        child: Column(
          children: [
                                ...
                                InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Icon(Icons.search, size: 14, color: primaryColor),
                                    ],
                                  ),
                                ),
                              ],
            ...
            if (isKeyboardVisible)
              Container(
                decoration: BoxDecoration(
                  color: isDark ? bgColor.withValues(alpha: 0.8) : Colors.white.withValues(alpha: 0.8),
                  border: Border(
                    top: BorderSide(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: Icon(
                              ...
                              color: _isListening ? Colors.red : (isDark ? Colors.grey.shade400 : Colors.grey.shade500),
                            ),
                          ),
                          IconButton(
                            onPressed: () {},
  ...
  void _showTitleEditModal(BuildContext context) {
    final TextEditingController modalController = TextEditingController(text: _titleController.text);
    final isDark = Theme.of(context).brightness == Brightness.dark;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? primaryColor : primaryColor.withValues(alpha: isDark ? 0.2 : 0.1),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
