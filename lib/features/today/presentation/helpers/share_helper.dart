...
const _shareText =
    'Check out Elbiblio - a daily companion for prayer, Scripture, and '
    'faithful practice.\n\nDownload it and begin with grace today.';
  ...
  try {
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Unable to share app')));
    }
  }
