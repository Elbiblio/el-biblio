...
class PermissionService {
  ...
  Future<Map<String, ph.PermissionStatus>> checkMeditationPermissions() async {
    final Map<String, ph.PermissionStatus> status = {};
  ...
  Map<String, String> getPermissionStatusMessages(
    Map<String, ph.PermissionStatus> status,
  ) {
    ...
    for (final entry in status.entries) {
      ...
      switch (permissionStatus) {
        ...
        case ph.PermissionStatus.permanentlyDenied:
          messages[permission] =
              'Permanently denied - Please enable in settings';
          break;
