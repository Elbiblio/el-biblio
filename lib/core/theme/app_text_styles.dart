...
extension AppTextStyles on TextTheme {
  ...
  TextStyle get verseNumber => bodySmall!.copyWith(
    fontWeight: FontWeight.bold,
  );

  /// User profile name display (ceremonial/brand)
  TextStyle get profileName => headlineLarge!.copyWith(
    fontStyle: FontStyle.italic,
  );

  /// Large display numbers (stats, points)
  TextStyle get displayNumber => displayLarge!.copyWith(
    height: 1.0,
  );

  /// Medium display numbers (stats, metrics)
  TextStyle get mediumNumber => headlineMedium!.copyWith(
    fontStyle: FontStyle.italic,
  );
  ...
  TextStyle get journalTitle => headlineMedium!.copyWith(
    fontWeight: FontWeight.w300,
    height: 1.3,
  );

  /// Journal body text (readable content)
  TextStyle get journalBody => bodyMedium!.copyWith(
    fontWeight: FontWeight.w300,
    height: 1.6,
  );
  ...
  TextStyle get ceremonialHeading => displaySmall!.copyWith(
    fontWeight: FontWeight.w600,
    letterSpacing: 0.5,
  );

  /// Brand identity elements (app titles, major section headers)
  TextStyle get brandTitle => headlineLarge!.copyWith(
    fontWeight: FontWeight.w700,
    letterSpacing: -0.5,
  );
